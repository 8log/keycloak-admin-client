...
/**
 Get Keycloak Admin client token
 */

function getToken(client, settings) {
  return settings.accessToken ? Promise.resolve(settings.accessToken) : requestToken(client.baseUrl, settings);
}
...
function keycloakAdminClient(settings) {
  ...
  Object.assign(client, bindModule(client, {
    ...
    getToken: getToken.bind(null, client, settings)
  });
